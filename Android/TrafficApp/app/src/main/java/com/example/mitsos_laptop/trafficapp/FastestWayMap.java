...
public class FastestWayMap extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void parseJSon(JSONObject jsonData) throws JSONException {
        ...
        for (int i = 0; i < jsonRoutes.length(); i++) {
            Log.d("route Size",jsonRoutes.length()+"");
            ...
            Log.d("Route",route.getDistance().toString());
            routes.add(route);
        }
        //Log.d("ROUTEESSS", routes.toString());
